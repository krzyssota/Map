 ...
 *  @param[in] city – wskaźnik na miasto.
  * @param[in] roadList - wskaźnik na listę dróg;
  * @param[in] road - wskaźnik na drogę.
 * @return Jeśli true udało się dodać drogę do miasta. W przeciwnym wypadku false.
 */
 ...
 *  @param[in] city – wskaźnik na miasto.
 * @return Jeśli true udało się dodać miasto do mapy. W przeciwnym wypadku false.
 */
 ...
 * @param[in] city – wskaźnik na miasto;
 * @return Wartość true, jeśli droga krajowa zawiera drogę. W przeciwnym wypadku false.
 */
